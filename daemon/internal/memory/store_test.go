...
func TestList(t *testing.T) {
	s := newTestStore()
	_ = s.Create("m1", "A", "1.0.0", TypePerAgent, "a")
...
func TestUnmountAll(t *testing.T) {
	s := newTestStore()
	_ = s.Create("m1", "A", "1.0.0", TypeShared, "")
	_ = s.Create("m2", "B", "1.0.0", TypePublic, "")
	_ = s.Mount("m1", "agent-a", AccessReadOnly)
	_ = s.Mount("m2", "agent-a", AccessReadOnly)
...
func TestPerAgentLimitOnePerAgent(t *testing.T) {
	s := newTestStore()
	_ = s.Create("m1", "A", "1.0.0", TypePerAgent, "agent-a")
	_ = s.Create("m2", "B", "1.0.0", TypePerAgent, "agent-a")
...
func TestPublicAlwaysReadOnly(t *testing.T) {
	s := newTestStore()
	_ = s.Create("m1", "A", "1.0.0", TypePublic, "")
