...
(function() {
  ...
  function ProfilesList(props) {
    ...
    return h(React.Fragment, null, profiles.map((profile, index) => {
  ...
  function BindingsList(props) {
    ...
    return h(React.Fragment, null, bindings.map((binding, index) => {
  ...
  function renderProfilesAndBindings(profilesContainer, bindingsContainer, profiles, bindings, actions) {
    ...
    if (!profilesRoot || !bindingsRoot)
      return false;
    profilesRoot.render(h(ProfilesList, {
      profiles,
